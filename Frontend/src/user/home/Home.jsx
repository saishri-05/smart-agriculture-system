...
const features = [
  {
    ...
    text: "Monitor your farm conditions 24/7 with live sensor data.",
  },
  {
    icon: Bot,
    title: "IoT Robot Data Collection",
    text: "Automated data gathering across your entire farm.",
  },
  {
    icon: Brain,
    title: "AI Crop Recommendations",
    text: "Get intelligent insights for optimal crop growth.",
  },
  {
    icon: Droplets,
    title: "Smart Irrigation",
    text: "Save water by irrigating only when your soil needs it.",
  },
  {
    icon: CloudSun,
    title: "Weather Insights",
    text: "Know rain, wind, and temperature before planning work.",
  },
  {
    icon: ShieldAlert,
    title: "Simple Alerts",
    text: "Receive clear warnings for water, crop, and robot issues.",
  },
];
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 lg:grid-cols-2 lg:py-32">
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-2xl shadow-[#b8d4a0]/60">
          <img
            ...
            className="h-[26rem] w-full object-cover lg:h-[28rem]"
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <article key={feature.title} className="rounded-2xl border border-[#dce8cc] bg-[#f6f9f0] p-8 shadow-md transition hover:-translate-y-1 hover:shadow-lg">
                <span className="inline-flex rounded-xl bg-[#2a7a2a] p-4 text-white shadow-sm">
                  <feature.icon size={36} />
                </span>
                <h3 className="mt-6 text-2xl font-black text-[#2a7a2a]">{feature.title}</h3>
                <p className="mt-3 text-lg leading-7 text-[#4a5a3a]">{feature.text}</p>
              </article>
            ))}
          </div>
        </div>
